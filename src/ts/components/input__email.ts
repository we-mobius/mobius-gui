...
import { makeEmailInputE } from '../elements/input__email'

import type { ClassUnion, EventHandler } from 'MobiusUtils'
import type { GUIDriverOptions, GUIDriverLevelContexts, GUIDriverSingletonLevelContexts } from '../helpers/index'
import type { TemplateResult } from '../libs/lit-html'
import type { EmailInputElementType, EmailInputValue } from '../elements/input__email'
...
makeDriverFormatComponent<GUIDriverOptions, GUIDriverLevelContexts, EmailInputDCSingletonLevelContexts, TemplateResult>({
  prepareSingletonLevelContexts: (options, driverLevelContexts) => {
    ...
    const minlengthRD = replayWithLatest(1, Data.of(0))
    const maxlengthRD = replayWithLatest(1, Data.of(999))
    const multipleRD = replayWithLatest(1, Data.of(false))
    const placeholderRD = replayWithLatest(1, Data.of(''))
