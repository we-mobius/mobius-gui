...
import { makeURLInputE } from '../../elements/inputs/input__url'

import type { ClassUnion, EventHandler } from 'MobiusUtils'
import type { GUIDriverOptions, GUIDriverLevelContexts, GUIDriverSingletonLevelContexts } from '../../helpers/index'
import type { TemplateResult } from '../../libs/lit-html'
import type { URLInputElementType, URLInputValue } from '../../elements/inputs/input__url'

export interface URLInputDCSingletonLevelContexts extends GUIDriverSingletonLevelContexts {
  inputs: {
    styles: {
...
export const makeURLInputDC =
makeDriverFormatComponent<GUIDriverOptions, GUIDriverLevelContexts, URLInputDCSingletonLevelContexts, TemplateResult>({
  prepareSingletonLevelContexts: (options, driverLevelContexts) => {
    const typeD = Data.of<URLInputElementType>('URLInput')
    const nameD = Data.of('')
    ...
    const [valueChangeHandlerRD, , inputValueD] = makeGeneralCallback<URLInputValue>()
  ...
  prepareTemplate: ({ marks, styles, actuations }) => {
    return makeURLInputE({ marks, styles, actuations })
  }
})

/**
 * @see {@link makeURLInputDC}
 */
export const useURLInputDC = useGUIDriver_(makeURLInputDC)
