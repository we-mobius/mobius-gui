...
import { makeWeekInputE } from '../../elements/inputs/input__week'

import type { ClassUnion, EventHandler } from 'MobiusUtils'
import type { GUIDriverOptions, GUIDriverLevelContexts, GUIDriverSingletonLevelContexts } from '../../helpers/index'
import type { TemplateResult } from '../../libs/lit-html'
import type { WeekInputElementType, WeekInputValue } from '../../elements/inputs/input__week'

export interface WeekInputDCSingletonLevelContexts extends GUIDriverSingletonLevelContexts {
  inputs: {
    styles: {
...
export const makeWeekInputDC =
makeDriverFormatComponent<GUIDriverOptions, GUIDriverLevelContexts, WeekInputDCSingletonLevelContexts, TemplateResult>({
  prepareSingletonLevelContexts: (options, driverLevelContexts) => {
    const typeD = Data.of<WeekInputElementType>('WeekInput')
    const nameD = Data.of('')
    ...
    const [valueChangeHandlerRD, , inputValueD] = makeGeneralCallback<WeekInputValue>()
  ...
  prepareTemplate: ({ marks, styles, actuations }) => {
    return makeWeekInputE({ marks, styles, actuations })
  }
})
 ...
 */
export const useWeekInputDC = useGUIDriver_(makeWeekInputDC)
