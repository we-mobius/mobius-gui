...
import { makeTextInputE } from '../../elements/inputs/input__text'

import type { ClassUnion, EventHandler } from 'MobiusUtils'
import type { GUIDriverOptions, GUIDriverLevelContexts, GUIDriverSingletonLevelContexts } from '../../helpers/index'
import type { TemplateResult } from '../../libs/lit-html'
import type { TextInputElementType, TextInputValue } from '../../elements/inputs/input__text'

export interface TextInputDCSingletonLevelContexts extends GUIDriverSingletonLevelContexts {
  inputs: {
    styles: {
...
export const makeTextInputDC =
makeDriverFormatComponent<GUIDriverOptions, GUIDriverLevelContexts, TextInputDCSingletonLevelContexts, TemplateResult>({
  prepareSingletonLevelContexts: (options, driverLevelContexts) => {
    const typeD = Data.of<TextInputElementType>('TextInput')
    const nameD = Data.of('')
    ...
    const [valueChangeHandlerRD, , inputValueD] = makeGeneralCallback<TextInputValue>()
  ...
  prepareTemplate: ({ marks, styles, actuations }) => {
    return makeTextInputE({ marks, styles, actuations })
  }
})

/**
 * @see {@link makeTextInputDC}
 */
export const useTextInputDC = useGUIDriver_(makeTextInputDC)
