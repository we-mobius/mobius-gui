...
import { makeTelInputE } from '../../elements/inputs/input__tel'

import type { ClassUnion, EventHandler } from 'MobiusUtils'
import type { GUIDriverOptions, GUIDriverLevelContexts, GUIDriverSingletonLevelContexts } from '../../helpers/index'
import type { TemplateResult } from '../../libs/lit-html'
import type { TelInputElementType, TelInputValue } from '../../elements/inputs/input__tel'

export interface TelInputDCSingletonLevelContexts extends GUIDriverSingletonLevelContexts {
  inputs: {
    styles: {
...
export const makeTelInputDC =
makeDriverFormatComponent<GUIDriverOptions, GUIDriverLevelContexts, TelInputDCSingletonLevelContexts, TemplateResult>({
  prepareSingletonLevelContexts: (options, driverLevelContexts) => {
    const typeD = Data.of<TelInputElementType>('TelInput')
    const nameD = Data.of('')
    ...
    const [valueChangeHandlerRD, , inputValueD] = makeGeneralCallback<TelInputValue>()
  ...
  prepareTemplate: ({ marks, styles, actuations }) => {
    return makeTelInputE({ marks, styles, actuations })
  }
})

/**
 * @see {@link makeTelInputDC}
 */
export const useTelInputDC = useGUIDriver_(makeTelInputDC)
